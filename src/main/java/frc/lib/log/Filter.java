...
/**
 * Filter implementations have the ability to determine whether or not a give
 * log event should be passed to a handler.
 */
public interface Filter {

    /**
     * Determines whether a loggable event meets this Filter instance's criteria.
     * 
     ...
     * @return {@code true} if this message passes the filter, {@code false}
     *         otherwise.
     */
