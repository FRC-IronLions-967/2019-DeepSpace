 ...
 * 
 * This class tracks all aspects of a loggable event such as its severity level,
 * the message, the original logger to which it was submitted, and an optional
...
public final class LogEvent {
    ...
    /**
     * Constructs a new LogEvent with the given severity, and message that was
     * originally submitted to the given logger.
     * 
     ...
     * 
     * If this method returns {@code true}, {@link #getThrowable()} will return
     * {@code null}.
     * 
    ...
    /**
     * Returns the optional Throwable associated with this LogEvent, it it exists.
     * 
     * @return Returns the Throwable instance associated with this LogEvent if it
     ...
     * 
     * This value can be used to retrieve information about the dispatching Logger
     * and the source of this event.
     * 
     ...
     * 
     * Another object is equal to this LogEvent if it is also a LogEvent instance
     * and if its {@link #getLevel()}, {@link #getMessage()},
     * {@link #getOriginalLogger()}, and {@link #getThrowable()} methods return
     * equal values.
     * 
     * @param other The object to be tested for equality against this LogEvent.
    ...
    public boolean equals(Object other) {
        if (other instanceof LogEvent) {
            ...
            return otherEvent.getLevel().equals(getLevel()) && otherEvent.getMessage().equals(getMessage())
                    && otherEvent.getOriginalLogger().equals(getOriginalLogger())
                    && (otherEvent.getThrowable() != null ? otherEvent.getThrowable().equals(getThrowable())
                            : getThrowable() == null);
        }
        return false;
    }
     ...
     * whether or not this LogEvent has an associated Throwable. The String has the
     * form: [-level name-] -original logger name-: -message- -Throwable- If no
     * Throwable is associated with this LogEvent, the second line is omitted.
     * 
     * @return A String representation of this LogEvent.
     */
    public String toString() {
        String stringRepresentation = "[" + getLevel() + "] " + getOriginalLogger().getFullNameWithoutRoot() + ": \""
                + message + "\"";
        if (hasThrowable()) {
