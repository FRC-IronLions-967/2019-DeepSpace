...
public final class LogSystem {
     ...
     * 
     * This method implicitly adds the root Logger's name to the provided name. The
     * provided name should omit the name of the root Logger. If the requested
     * Logger does not exist, it will be created.
     * 
    ...
    public static Logger getLogger(String fullNameWitoutRoot) {
        if (fullNameWitoutRoot.indexOf(" ") >= 0) {
            throw new IllegalArgumentException(
                    "Logger names may not contain \" \" (received: " + fullNameWitoutRoot + ")");
        }
