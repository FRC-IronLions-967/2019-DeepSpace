...
public final class Level {
    ...
    /**
     * Represents an unrecoverable error that will cause the robot program (or a
     * thread) to exit.
     */
    public static final Level FATAL = new Level((byte) 5, "fatal");

    /**
     * Represents a severe error that may cause unintended operation. The error is
     * severe, but the program can continue.
     */
    ...
    /**
     * A non-error informational message. Messages at this level should be
     * interpreted as normal.
     */
    public static final Level INFO = new Level((byte) 2, "info");

    /**
     * A debugging message. This logging level should be used with less frequency
     * than {@link #TRACE}.
     */
     ...
     * 
     * The parameter indicates the ordering of this logging level in severity.
     * Higher values indicate a greater severity.
     * 
    ...
    /**
     * This method allows access to the private byte used to order this Level by
     * severity.
     * 
     ...
     * 
     * An object is equal to this Level if it is also a Level object and if it has
     * the same severity value.
     * 
     ...
     * 
     * Returns a positive number if this Level is more severe than {@code other}, a
     * negative number if the Level is less severe than {@code other}, or 0 if the
     * levels are equal in severity.
     * 
     * @param other The other Level to be compared to this one for severity
     *              ordering.
     * @return A positive number, a negative number or zero indicating the ordering
     *         of this Level versus {@code other} by severity.
     */
     ...
     * 
     * The returned String is equivalent to the value returned by the
     * {@link #getName()} method.
     * 
